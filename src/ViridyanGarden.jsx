...
const PLANTS = [
  { id:1,  name:"Aloe Vera",        sci:"Aloe barbadensis miller",   family:"Asphodelaceae",  uses:"Wound healing, burns, digestive soothing, skin hydration",         history:"Ancient Egyptians called it 'plant of immortality' ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ used for 6000 years in rituals and medicine",          modern:"Active in cosmetics, gels, sunburn creams, IBS supplements",           icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Âµ", color:0x5a9e3f, type:"aloe",      h:1.1, w:0.7  },
  { id:2,  name:"Lavender",         sci:"Lavandula angustifolia",    family:"Lamiaceae",       uses:"Anxiety relief, insomnia, headaches, antiseptic wounds",            history:"Romans perfumed baths with it; medieval Europeans hung it to ward off plague",                            modern:"Aromatherapy, essential oils, calming supplements, sleep sprays",       icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€¦Ã¢â‚¬Å“", color:0x9b6fbf, type:"bush",       h:0.85,w:0.75 },
  { id:3,  name:"Chamomile",        sci:"Matricaria chamomilla",     family:"Asteraceae",      uses:"Relaxation, digestive relief, anti-inflammatory, skin soothing",   history:"Ancient Egypt dedicated chamomile to the sun god Ra; used in embalming pharaohs",                        modern:"Herbal teas, skincare serums, calming gummies",                        icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¼", color:0xe8c53a, type:"flower",     h:0.55,w:0.5  },
  { id:4,  name:"Echinacea",        sci:"Echinacea purpurea",        family:"Asteraceae",      uses:"Immune boost, cold/flu prevention, anti-viral properties",          history:"Native Americans relied on it for 400+ years for infections and pain",                                   modern:"Cold supplements, immune tablets, syrup formulations",                 icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Âº", color:0xd45a8a, type:"flower",     h:0.8, w:0.55 },
  { id:5,  name:"Ginger",           sci:"Zingiber officinale",       family:"Zingiberaceae",   uses:"Nausea, digestion, joint pain, potent anti-inflammatory",           history:"Traded on the Silk Road 5000 years ago; key in Chinese and Ayurvedic medicine",                        modern:"Anti-nausea drugs, digestive aids, anti-arthritis research",           icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â«Ãƒâ€¦Ã‚Â¡", color:0xc07830, type:"herb",       h:0.65,w:0.85 },
  { id:6,  name:"Turmeric",         sci:"Curcuma longa",             family:"Zingiberaceae",   uses:"Anti-inflammatory, antioxidant, joint and liver health",            history:"Ayurvedic staple for 4000 years; golden colour sacred in Hindu rituals",                              modern:"Curcumin supplements, anti-cancer research, golden milk trend",        icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¡", color:0xf0a020, type:"herb",       h:0.65,w:0.9  },
  { id:7,  name:"Peppermint",       sci:"Mentha ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â piperita",         family:"Lamiaceae",       uses:"IBS relief, headaches, respiratory clearing, topical pain relief",  history:"Found in Egyptian pyramids; ancient Greeks and Romans crowned themselves with mint",                     modern:"IBS capsules, topical pain gels, breath fresheners",                   icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿", color:0x2db870, type:"groundcover",h:0.35,w:0.6  },
  { id:8,  name:"St. John's Wort",  sci:"Hypericum perforatum",      family:"Hypericaceae",    uses:"Mild depression, anxiety, nerve pain, wound healing",               history:"Medieval monks called it devil's scourge; hung over doors on St. John's Day",                          modern:"OTC antidepressants, anxiety supplements, neuropathy research",        icon:"ÃƒÆ’Ã‚Â¢Ãƒâ€šÃ‚Â­Ãƒâ€šÃ‚Â", color:0xddb830, type:"bush",       h:0.7, w:0.55 },
  { id:9,  name:"Valerian",         sci:"Valeriana officinalis",     family:"Caprifoliaceae",  uses:"Insomnia, anxiety, muscle cramps, natural sedation",                history:"Ancient Greeks and Romans used it as perfume and sedative; Hippocrates documented it",                  modern:"Sleep supplements, anxiety capsules, non-habit forming sedatives",     icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â", color:0xd8d0c0, type:"bush",       h:1.0, w:0.5  },
  { id:10, name:"Ashwagandha",      sci:"Withania somnifera",        family:"Solanaceae",      uses:"Stress adaptogen, energy boost, cognitive function, testosterone",  history:"3000-year Ayurvedic horse herb for strength and vitality",                                             modern:"Adaptogen supplements, sports nutrition, cortisol blockers",           icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾", color:0xc07828, type:"bush",       h:0.9, w:0.75 },
  { id:11, name:"Neem",             sci:"Azadirachta indica",        family:"Meliaceae",       uses:"Antibacterial, antifungal, dental health, skin conditions",         history:"India's Village Pharmacy for 5000 years; sacred in Hinduism",                                         modern:"Toothpaste, bio-pesticides, antifungal skincare",                      icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â³", color:0x2a7040, type:"tree",       h:3.2, w:1.7  },
  { id:12, name:"Holy Basil",       sci:"Ocimum tenuiflorum",        family:"Lamiaceae",       uses:"Stress relief, immune support, respiratory health, blood sugar",    history:"Sacred Tulsi of Hinduism; each home kept a plant for spiritual protection",                            modern:"Adaptogen teas, Ayurvedic formulations, anti-diabetic research",       icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â±", color:0x28b870, type:"herb",       h:0.55,w:0.5  },
  { id:13, name:"Rosemary",         sci:"Salvia rosmarinus",         family:"Lamiaceae",       uses:"Memory boost, hair growth, circulation, antioxidant protection",    history:"Greek students wore garlands for better memory; symbolised remembrance at funerals",                    modern:"Cognitive supplements, hair serums, rosmarinic acid research",         icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿", color:0x3a8850, type:"bush",       h:0.85,w:0.65 },
  { id:14, name:"Milk Thistle",     sci:"Silybum marianum",          family:"Asteraceae",      uses:"Liver protection, detox, anti-inflammatory, antioxidant",           history:"Roman naturalist Pliny used it for liver complaints 2000 years ago",                                   modern:"Liver supplements, hepatitis support, silymarin extracts",             icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â®", color:0x8844b8, type:"bush",       h:0.95,w:0.75 },
  { id:15, name:"Garlic",           sci:"Allium sativum",            family:"Amaryllidaceae",  uses:"Heart health, antibacterial, blood pressure, immune boost",         history:"Egyptian pyramid builders ate it for endurance; plague doctors carried it",                            modern:"Cardiovascular supplements, allicin research, antibiotic alternatives",icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â§ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾", color:0xe8e0c0, type:"herb",       h:0.45,w:0.4  },
  { id:16, name:"Elderberry",       sci:"Sambucus nigra",            family:"Adoxaceae",       uses:"Flu, antiviral, immune support, anti-inflammatory properties",      history:"Hippocrates called the elderberry his medicine chest 400 BC",                                         modern:"Antiviral syrups, gummies, COVID-19 research support",                 icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â«Ãƒâ€šÃ‚Â", color:0x5a3880, type:"tree",       h:2.2, w:1.3  },
  { id:17, name:"Ginkgo",           sci:"Ginkgo biloba",             family:"Ginkgoaceae",     uses:"Memory enhancement, circulation, dementia prevention, antioxidant",  history:"270-million-year-old living fossil; survived the Hiroshima atomic blast",                              modern:"Cognitive supplements, dementia research, circulatory drugs",          icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€ Ã¢â‚¬â„¢", color:0xc8a820, type:"tree",       h:3.5, w:1.6  },
  { id:18, name:"Passionflower",    sci:"Passiflora incarnata",      family:"Passifloraceae",  uses:"Anxiety reduction, insomnia, ADHD, nerve pain management",          history:"Aztecs and Native Americans used it as a sedative and pain reliever",                                  modern:"Anxiety capsules, sleep aids, ADHD natural alternatives",              icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¸", color:0xb050d0, type:"flower",     h:0.75,w:1.0  },
  { id:19, name:"Calendula",        sci:"Calendula officinalis",     family:"Asteraceae",      uses:"Wound healing, skin inflammation, antifungal, eczema relief",       history:"Medieval Europe used marigold petals for fevers, wounds, and as food colouring",                       modern:"Wound gels, baby skincare, antifungal creams",                         icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â»", color:0xf07020, type:"flower",     h:0.5, w:0.5  },
  { id:20, name:"Feverfew",         sci:"Tanacetum parthenium",      family:"Asteraceae",      uses:"Migraine prevention, fever reduction, arthritis, anti-inflammatory", history:"Ancient Greeks used it for headaches; called medieval aspirin by historians",                           modern:"Migraine prevention supplements, parthenolide research",               icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¼", color:0xe8d040, type:"flower",     h:0.6, w:0.5  },
  { id:21, name:"Hawthorn",         sci:"Crataegus monogyna",        family:"Rosaceae",        uses:"Heart health, blood pressure, anxiety, circulation support",        history:"European medieval heart tonic; associated with fairies and May Day",                                  modern:"Cardiac supplements, hypertension research, flavonoid therapy",        icon:"ÃƒÆ’Ã‚Â¢Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â¤ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â", color:0xd03838, type:"tree",       h:2.5, w:1.4  },
  { id:22, name:"Lemon Balm",       sci:"Melissa officinalis",       family:"Lamiaceae",       uses:"Anxiety, digestion, cold sores, sleep quality improvement",         history:"Avicenna prescribed it to make the heart merry in 11th-century Islamic medicine",                     modern:"Calming teas, antiviral lip creams, GABA receptor research",           icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹", color:0x90c840, type:"herb",       h:0.6, w:0.7  },
  { id:23, name:"Marshmallow Root", sci:"Althaea officinalis",       family:"Malvaceae",       uses:"Sore throat, GI lining protection, urinary tract, dry cough",       history:"Ancient Egyptians made throat lozenges from it; Romans used it for respiratory illness",             modern:"Throat syrups, gut-lining supplements, mucilage therapy",              icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â", color:0xf0e8d8, type:"herb",       h:1.0, w:0.65 },
  { id:24, name:"Oregano",          sci:"Origanum vulgare",          family:"Lamiaceae",       uses:"Antimicrobial, antioxidant, respiratory health, carvacrol benefits", history:"Greeks called it joy of the mountain; Aphrodite's symbol of happiness",                              modern:"Oregano oil supplements, carvacrol antimicrobial research",            icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿", color:0x4a9850, type:"groundcover",h:0.35,w:0.65 },
  { id:25, name:"Plantain",         sci:"Plantago major",            family:"Plantaginaceae",  uses:"Wound healing, cough relief, antibacterial, anti-itch properties",  history:"Native Americans called it White Man's Foot as it spread along colonial trails",                      modern:"Cough syrups, wound sprays, aucubin anti-inflammatory research",       icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â±", color:0x38a040, type:"groundcover",h:0.25,w:0.5  },
  { id:26, name:"Red Clover",       sci:"Trifolium pratense",        family:"Fabaceae",        uses:"Menopause support, bone density, cholesterol, skin health",         history:"Traditional across Eurasia as fodder and healing herb for centuries",                                  modern:"Phytoestrogen supplements, HRT alternatives, bone health research",    icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¸", color:0xd84878, type:"flower",     h:0.45,w:0.5  },
  { id:27, name:"Saw Palmetto",     sci:"Serenoa repens",            family:"Arecaceae",       uses:"Prostate health, hair loss prevention, testosterone balance",       history:"Seminole tribe of Florida used berries as food and reproductive medicine",                            modern:"Prostate supplements, DHT blocker hair loss products",                 icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â´", color:0x48a048, type:"bush",       h:1.3, w:1.5  },
  { id:28, name:"Spearmint",        sci:"Mentha spicata",            family:"Lamiaceae",       uses:"Digestion, hormonal balance for PCOS, memory, hirsutism",           history:"Ancient Rome used spearmint at feasts to stimulate appetite",                                         modern:"PCOS research, digestive teas, anti-androgen studies",                 icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿", color:0x58d870, type:"groundcover",h:0.4, w:0.55 },
  { id:29, name:"Thyme",            sci:"Thymus vulgaris",           family:"Lamiaceae",       uses:"Bronchitis, antibacterial, cough relief, expectorant action",       history:"Egyptians used thyme in embalming; Greek soldiers bathed in it for courage",                          modern:"Respiratory syrups, thymol in mouthwash and antiseptics",              icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿", color:0x70b060, type:"groundcover",h:0.3, w:0.45 },
  { id:30, name:"Yarrow",           sci:"Achillea millefolium",      family:"Asteraceae",      uses:"Wound healing, blood pressure, fever reduction, anti-inflammatory",  history:"Named after Achilles who used it to stop bleeding of warrior wounds",                                 modern:"Wound care products, blood pressure research, achillin studies",       icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¸", color:0xf8f0e8, type:"flower",     h:0.7, w:0.5  },
  { id:31, name:"Witch Hazel",      sci:"Hamamelis virginiana",      family:"Hamamelidaceae",  uses:"Skin toner, acne treatment, hemorrhoids, varicose veins",           history:"Native American tribes steamed witch hazel bark to reduce swelling and bruising",                     modern:"Astringent toners, hemorrhoid creams, anti-acne skincare",             icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡", color:0xc88830, type:"tree",       h:2.0, w:1.3  },
  { id:32, name:"Dandelion",        sci:"Taraxacum officinale",      family:"Asteraceae",      uses:"Liver detox, digestion support, diuretic, rich iron source",        history:"Mentioned in 10th-century Arab medicine by Ibn Sina as a liver tonic",                               modern:"Liver supplements, prebiotic teas, inulin fibre research",             icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¼", color:0xf0d020, type:"flower",     h:0.3, w:0.4  },
  { id:33, name:"Cat's Claw",       sci:"Uncaria tomentosa",         family:"Rubiaceae",       uses:"Immune boost, arthritis, anti-viral, potential anti-tumour effects", history:"Peruvian Amazon tribes used vine bark for centuries for immune and joint health",                     modern:"Arthritis supplements, immune therapy, oxindole alkaloid research",    icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿", color:0x789060, type:"bush",       h:1.5, w:0.9  },
  { id:34, name:"Licorice Root",    sci:"Glycyrrhiza glabra",        family:"Fabaceae",        uses:"Sore throat, adrenal fatigue, gastric ulcers, anti-viral support",  history:"Found in Tutankhamun's tomb; Chinese emperors called it the great harmonizer",                       modern:"Throat lozenges, GI ulcer treatment, DGL supplements",                 icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾", color:0x9a7850, type:"bush",       h:0.85,w:0.7  },
  { id:35, name:"Stinging Nettle",  sci:"Urtica dioica",             family:"Urticaceae",      uses:"Allergies, arthritis, kidney health, rich iron supplementation",    history:"Bronze Age Europeans wove nettle fibres into fabric; Roman soldiers used it for warmth",            modern:"Allergy supplements, anti-arthritis, iron-rich cooking ingredient",    icon:"ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿", color:0x2a8838, type:"bush",       h:1.1, w:0.6  },
];
...
function buildScene(canvas) {
  ...
  // ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ Character (armored soldier) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬
...
// ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ Minimap ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬
...
function LeafMark({ size = 28 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden="true">
      <defs>
        <radialGradient id="leafGlow" cx="30%" cy="25%" r="80%">
          <stop offset="0%" stopColor="#92dd8d" />
          <stop offset="100%" stopColor="#1f6b2a" />
        </radialGradient>
      </defs>
      <circle cx="16" cy="16" r="15" fill="url(#leafGlow)" />
      <path
        d="M11 20c0-5.4 4.2-9.2 10-10-0.8 5.8-4.6 10-10 10zm0 0c1.4-2 3.4-3.6 5.8-4.6"
        fill="none"
        stroke="#eaf8e7"
        strokeWidth="1.8"
        strokeLinecap="round"
...
export default function ViridyanGarden({ onBack }) {
  ...
  useEffect(()=>{
    ...
    const tick=()=>{
      ...
      if(nm!==state.mode){state.mode=nm;}
    ...
    <div style={{width:"100vw",height:"100vh",overflow:"hidden",position:"relative",background:"#060f06",
      ...
      >
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <LeafMark size={28} />
          <div>
            <div style={{color:"#c8e6c9",fontSize:18,fontWeight:700,letterSpacing:3,lineHeight:1}}>
              VIRIDYAN
            </div>
            <div style={{color:"#81c784",fontSize:9,letterSpacing:3,opacity:0.85}}>
              VIRTUAL GARDEN
            </div>
          </div>
        </div>
        <div style={{color:"rgba(190,230,190,0.7)",fontSize:10,letterSpacing:2,textTransform:"uppercase"}}>
          Explore the World
        </div>
        {onBack && (
          <button
      ...
      <div style={{position:"absolute",bottom:148,right:22,width:130,height:130,userSelect:"none"}}>
        {[{l:"W",c:"KeyW",t:0,x:46},{l:"A",c:"KeyA",t:46,x:0},{l:"S",c:"KeyS",t:92,x:46},{l:"D",c:"KeyD",t:46,x:92}].map(b=>(
        ...
        <div onClick={()=>setSelPlant(null)} style={{
          ...
          <div onClick={e=>e.stopPropagation()} style={{
            ...
            <button onClick={()=>setSelPlant(null)} style={{position:"absolute",top:14,right:14,
              ...
              color:"#81c784",cursor:"pointer",fontSize:14,display:"flex",alignItems:"center",justifyContent:"center"}}>X</button>
            <div style={{display:"flex",alignItems:"flex-start",gap:16,marginBottom:22}}>
              <div style={{fontSize:52,lineHeight:1,filter:`drop-shadow(0 0 14px #${selPlant.color.toString(16).padStart(6,"0")}99)`}}>
                {selPlant.name.slice(0,1)}
              </div>
              <div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:11}}>
              {[
                {lbl:"MEDICINAL USES",     txt:selPlant.uses,    ic:"USES",cl:"#a5d6a7"},
                {lbl:"HISTORICAL CONTEXT", txt:selPlant.history, ic:"HISTORY",cl:"#90caf9"},
                {lbl:"MODERN APPLICATIONS",txt:selPlant.modern,  ic:"MODERN",cl:"#ce93d8"},
              ].map(r=>(
      ...
      {intro&&(
        <div style={{position:"absolute",inset:0,background:"rgba(0,4,0,0.9)",
          ...
          <div style={{textAlign:"center",maxWidth:480,padding:"48px 40px",
            ...
            <div style={{display:"flex",justifyContent:"center",marginBottom:14,filter:"drop-shadow(0 0 22px rgba(100,200,100,0.55))"}}>
              <LeafMark size={56} />
            </div>
